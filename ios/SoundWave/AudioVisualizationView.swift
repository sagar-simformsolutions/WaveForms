...
public class AudioVisualizationView: BaseNibView {
    ...
    @objc var onAudioBuffers: RCTDirectEventBlock? = nil  {
      didSet {
        audioManager.onAudioBuffers = onAudioBuffers
      }
    }
    @objc var onAudioStoped: RCTDirectEventBlock? = nil  {
      didSet {
        audioManager.onAudioStoped = onAudioStoped
      }
    }
    @IBInspectable public var meteringLevelBarWidth: CGFloat = 4.0 {
        didSet {
    ...
    @IBInspectable public var meteringLevelBarCornerRadius: CGFloat = 5.0 {
        didSet {
          DispatchQueue.main.async {
            self.setNeedsDisplay()
          }
    ...
    public var audioVisualizationMode: AudioVisualizationMode = .write
